...
//            tr("")},
    ...
    treeWidget_triggers->setTreeType(TTreeWidget::TreeType::Trigger);
    ...
    treeWidget_aliases->setTreeType(TTreeWidget::TreeType::Alias);
    ...
    treeWidget_actions->setTreeType(TTreeWidget::TreeType::Action);
    ...
    treeWidget_timers->setTreeType(TTreeWidget::TreeType::Timer);
    ...
    treeWidget_variables->setTreeType(TTreeWidget::TreeType::Var);
    ...
    treeWidget_keys->setTreeType(TTreeWidget::TreeType::Key);
    ...
    treeWidget_scripts->setTreeType(TTreeWidget::TreeType::Script);
